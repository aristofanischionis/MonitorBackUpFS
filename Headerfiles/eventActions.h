...
void attribMode(struct inotify_event* event, char* path, char* backup,
                List* sourceList);
void modifyMode(struct inotify_event* event, char* path, char* backup,
                List* backupList);
void closeWriteMode(struct inotify_event* event, char* path, char* backup,
                    List* sourceList);
...
void movedToMode(struct inotify_event* event, int fd, char* path, char* backup,
                 List* sourceList, int* watched, WDmapping** map);
