/*
	An example application for the inotify Linux subsystem
	Based on code found on the internet here:
	http://www.thegeekstuff.com/2010/04/inotify-c-program-example/

	Purpose:
	Monitor a fixed set of files/directories using inotify 
	and display all events in a human readble form
	Usage: 
		inotify <list of names to watch>
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
